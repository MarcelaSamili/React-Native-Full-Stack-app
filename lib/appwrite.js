...
export const singOut = async () => {
  try {
    ...
    console.error('singOut Function error:', error.message);
  }
};

/*----Functions form create page---------------------------- */
...
export const getFilePreview = async (fileId, type) => {
  ...
  try {
    if (type === 'video') {
      ...
      console.error('Erro ao tentar acessar o tipo em getFilePreview');
    }
    if (!fileUrl) console.error('sem informações de fileUrl');

    return fileUrl;
  } catch (error) {
    console.error('Erro na função getFilePreview', error);
  }
};
...
export const uploadFile = async (file, type) => {
  ...
  try {
    ...
    console.error('Erro na função uploadFile', error.message);
  }
};
...
export const createVideo = async form => {
  try {
    ...
    console.error('Erro na função createVideo', error.message);
  }
};
