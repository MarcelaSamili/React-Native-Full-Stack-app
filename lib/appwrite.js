  ...
  try {
    ...
    const newUser = await databases.createDocument(
      ...
      ID.unique(),
      {
        ...
        email: email.toString().trim(), // Certifique-se de que está como string
        username,
        avatar: avatarsUrl,
      }
    );
    console.log('ID da conta criada:', newAccount.$id);
    console.log('email da conta criada:', email);
    console.log('Dados sendo enviados ao Appwrite:', JSON.stringify(newUser));
